...
venue: "KU Libraries Git Workshop"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Watson Library Clark Instruction Center, 1425 Jayhawk Boulevard, Lawrence, KS, 66045"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
humandate: "Jul 19, 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Tami Albin", "Jamene Brooks-Kieffer"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Jeremy Keeler", "Michael Peper", "Boryana Koseva"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["albin@ku.edu", "jamenebk@ku.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes: https://etherpad.wikimedia.org/p/20190719-git-ku            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
